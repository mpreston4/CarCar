...
from .views import api_technicians, api_delete_techinicians, api_appointment, api_delete_appointment, api_automobiles, api_finish_appointment, api_cancel_appointment
